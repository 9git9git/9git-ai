...
# Azure OpenAI 설정값 불러오기 (코딩 전용)
api_key = os.getenv("AZURE_OAI_KEY_CODING")                      # Azure OpenAI 키
api_version = os.getenv("AZURE_OAI_API_VERSION")                 # API 버전
endpoint = os.getenv("AZURE_OAI_ENDPOINT_CODING")                # 엔드포인트 주소
deployment = os.getenv("AZURE_OAI_DEPLOYMENT_CODING")            # 배포 이름 (모델 ID)
